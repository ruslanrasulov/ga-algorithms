...
const HelpWindow = props => (
    <div className='help-window-bg'>
        <div className='help-window'>
            ...
            <div className='note'>Фитнес-функция вычисляется по следующей формуле: <span className='text-bold'>кол-во однотипных клеток рядом</span> * <span className='text-bold'>П</span> * <span className='text-bold'>С</span></div>
